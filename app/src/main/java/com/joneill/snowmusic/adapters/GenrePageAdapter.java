 ...
 */
public class GenrePageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GenrePageAdapter(SongPlayerPanel songPanel, Genre genre, Context context, CollapsingToolbarLayout toolbar) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof PlaylistPageViewHolder) {
            ...
            holder.tvArtist.setText(genre.getGenre());
            holder.tvAlbum.setText(genre.getGenre());
    ...
    public class PlaylistPageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (songPanel.getMusicService().getList() != genre.getSongs()) {
                songPanel.getMusicService().setList(genre.getSongs());
            }
            songPanel.openSongInPanel(true, genre.getSongs().get(getPosition() - 1), false);
