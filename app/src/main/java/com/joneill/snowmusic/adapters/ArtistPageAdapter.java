 ...
 */
public class ArtistPageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtistPageAdapter(SongPlayerPanel songPanel, Artist artist, Context context, CollapsingToolbarLayout toolbar) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof PlaylistPageViewHolder) {
            ...
            holder.tvAlbum.setText(artist.getArtist());
    ...
    public class PlaylistPageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (songPanel.getMusicService().getList() != artist.getSongs()) {
                songPanel.getMusicService().setList(artist.getSongs());
            }
            songPanel.openSongInPanel(true, artist.getSongs().get(getPosition() - 1), false);
